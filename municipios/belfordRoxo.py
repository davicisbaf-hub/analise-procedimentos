...
def analisar_procedimentos_belfordRoxo():
    ...
    try:
        ...
        coluna_procedimento = 'Belford roxo'
        coluna_quantidade = 'Quantidade Belford roxo'
        ...
        df.to_excel("./relatorio-criado-municipio/belfordRoxo/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/belfordRoxo/{}.xlsx".format("Nao-listados"), index=False)
