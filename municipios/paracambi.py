...
def analisar_procedimentos_paracambi():
    ...
    try:
        ...
        coluna_procedimento = 'Paracambi'
        coluna_quantidade = 'Quantidade Paracambi'
        ...
        df.to_excel("./relatorio-criado-municipio/paracambi/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/paracambi/{}.xlsx".format("Nao-listados"), index=False)
