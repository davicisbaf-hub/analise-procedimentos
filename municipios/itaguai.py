...
def analisar_procedimentos_itaguai():
    ...
    try:
        ...
        coluna_procedimento = 'Itaguai'
        coluna_quantidade = 'Quantidade Itaguai'
        ...
        df.to_excel("./relatorio-criado-municipio/itaguai/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/itaguai/{}.xlsx".format("Nao-listados"), index=False)
