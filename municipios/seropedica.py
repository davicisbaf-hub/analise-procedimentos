...
def analisar_procedimentos_seropedica():
    ...
    try:
        ...
        coluna_procedimento = 'Seropedica'
        coluna_quantidade = 'Quantidade Seropedica'
        ...
        df.to_excel("./relatorio-criado-municipio/seropedica/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/seropedica/{}.xlsx".format("Nao-listados"), index=False)
