...
def analisar_procedimentos_japeri():
    ...
    try:
        ...
        df.to_excel("./relatorio-criado-municipio/japeri/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/japeri/{}.xlsx".format("Nao-listados"), index=False)
