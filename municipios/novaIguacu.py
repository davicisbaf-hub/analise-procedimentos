...
def analisar_procedimentos_nova_iguacu():
    ...
    try:
        ...
        coluna_procedimento = 'Nova Iguacu'
        coluna_quantidade = 'Quantidade Nova Iguacu'
        ...
        df.to_excel("./relatorio-criado-municipio/novaIguacu/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/novaIguacu/{}.xlsx".format("Nao-listados"), index=False)
