...
def analisar_procedimentos_mesquita():
    ...
    try:
        ...
        coluna_procedimento = 'Mesquita'
        coluna_quantidade = 'Quantidade Mesquita'
        ...
        df.to_excel("./relatorio-criado-municipio/mesquita/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/mesquita/{}.xlsx".format("Nao-listados"), index=False)
