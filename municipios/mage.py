...
def analisar_procedimentos_mage():
    ...
    try:
        ...
        df.to_excel("./relatorio-criado-municipio/mage/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/mage/{}.xlsx".format("Nao-listados"), index=False)
