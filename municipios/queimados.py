...
def analisar_procedimentos_queimados():
    ...
    try:
        ...
        df.to_excel("./relatorio-criado-municipio/queimados/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/queimados/{}.xlsx".format("Nao-listados"), index=False)
