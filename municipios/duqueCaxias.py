...
def analisar_procedimentos_duqueCaxias():
    ...
    try:
        ...
        coluna_procedimento = 'Duque de Caxias'
        coluna_quantidade = 'Quantidade Duque de Caxias'
        ...
        df.to_excel("./relatorio-criado-municipio/duqueCaxias/{}.xlsx".format(coluna_procedimento), index=False)
        ...
        df.to_excel("./relatorio-criado-municipio/duqueCaxias/{}.xlsx".format("Nao-listados"), index=False)
